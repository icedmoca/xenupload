<?php
// FROM HASH: 8addcf6f35714795ddb6e71854c23afb
...
<p>originalFindNewId = ' . $__templater->escape($__vars['originalFindNewId']) . ', findNewId = ' . $__templater->escape($__vars['findNew']['find_new_id']) . '</p>
