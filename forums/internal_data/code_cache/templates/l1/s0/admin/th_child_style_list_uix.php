	...
	';
			...
			foreach ($__compilerTemp2 AS $__vars['xmlName'] => $__vars['childStyle']) {
				...
				if (!$__vars['childStyle']['installed']) {
					$__compilerTemp3[] = array(
						...
						'href' => $__templater->fn('link', array('styles/themehouse/child-styles/install', null, array('product_id' => $__vars['product']['id'], 'style_id' => $__vars['style']['style_id'], 'child_style' => $__vars['xmlName'], ), ), false),
						'_type' => 'cell',
						'html' => 'Install',
					);
				}
		...
		<div class="block-container">
			...
			<div class="block-footer">
				<span class="u-pullRight">' . 'Showing ' . $__templater->fn('count', array($__vars['style']->{'th_child_style_cache_uix'}, ), true) . ' of ' . $__templater->fn('count', array($__vars['style']->{'th_child_style_cache_uix'}, ), true) . ' items' . '</span>
			</div>
		</div>
	', array(
