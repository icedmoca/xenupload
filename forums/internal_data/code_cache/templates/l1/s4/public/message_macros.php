...
return array('macros' => array('user_info' => function($__templater, array $__arguments, array $__vars)
{
	...
	<section itemscope itemtype="https://schema.org/Person" class="message-user">
		<div class="message-avatar ' . (($__vars['xf']['options']['showMessageOnlineStatus'] AND ($__vars['user'] AND $__templater->method($__vars['user'], 'isOnline', array()))) ? 'message-avatar--online' : '') . '">
			<div class="message-avatar-wrapper ' . (($__vars['user'] AND $__templater->method($__vars['user'], 'hasMinecraftAvatar', array())) ? 'MineSyncAvatar' : '') . '">
				';
	...
	$__finalCompiled .= '
		...
		'itemprop' => 'jobTitle',
				...
				' . $__templater->callMacro('ncms_player_macros', 'mc_showcase', array(
		'location' => 'message',
		'user' => $__vars['user'],
	), $__vars) . '
