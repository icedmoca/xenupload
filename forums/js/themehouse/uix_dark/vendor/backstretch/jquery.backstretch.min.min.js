...
c(k,h,g[n])}else"string"==typeof g[n]&&(g[n]={url:g[n]}),m=d.extend({},g[n]),m.url=b(m.url,t);f.push(m)}return f}}(),v=function(a){return u.test(a.url)||a.isVideo},B=function(a,c,b,e,g){var k=[],h=function(a){for(var b=0;b<k.length;b++)if(k[b].src===a.src)return k[b];return k.push(a),a};return function w(a,b,c,e,g){if("undefined"!=typeof a){d.isArray(a)||(a=[a]);5>arguments.length&&"function"==typeof arguments[arguments.length-1]&&(g=arguments[arguments.length-1]);b="function"!=typeof b&&b?b:0;c=
"function"==typeof c||!c||0>c?a.length:Math.min(c,a.length);e="function"!=typeof e&&e?e:1;b>=a.length&&(b=0,c=0);0>e&&(e=c);e=Math.min(e,c);var k=a.slice(b+e,c-e);if(a=a.slice(b,e),c=a.length,c)for(var f,l=0,m=function(){l++;l===c&&("function"==typeof g&&g.call(a,!k),w(k,0,0,e,g))},n=0;n<a.length;n++)v(a[n])||(f=new Image,f.src=a[n].url,f=h(f),f.complete?m():d(f).on("load error",m));else"function"==typeof g&&g.call(a,!0)}}}(),C=function(a){for(var c=[],b=0;b<a.length;b++)"string"==typeof a[b]?c.push({url:a[b]}):
d.isArray(a[b])?c.push(C(a[b])):c.push(D(a[b]));return c},D=function(a,c){(a.centeredX||a.centeredY)&&(f.console&&f.console.log&&f.console.log("jquery.backstretch: `centeredX`/`centeredY` is deprecated, please use `alignX`/`alignY`"),a.centeredX&&(a.alignX=.5),a.centeredY&&(a.alignY=.5));a.speed!==q&&(f.console&&f.console.log&&f.console.log("jquery.backstretch: `speed` is deprecated, please use `transitionDuration`"),a.transitionDuration=a.speed,a.transition="fade");a.resolutionChangeRatioTreshold!==
